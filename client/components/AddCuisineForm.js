...
const AddCuisineForm = props => {
  return (
    <div className="addcuisine-form-container">
      <span>
        Enter a a food type or description, e.g. 'healthy', 'italian', or
        'easy', to add it to the food
      </span>
      ...
      <button className="exit-btn" type="submit" onClick={props.hideAddCuisineForm}>
        X
      </button>
    </div>
  );
